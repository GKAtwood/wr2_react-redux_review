...
import {increaseCount, decreaseCount, resetCount} from '../../redux/reducers/countReducer';
...
export default connect(null, {increaseCount, decreaseCount, resetCount}) (ButtonControl);